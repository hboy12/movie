...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>Hᴇʏ Dᴜᴅᴇ🥰,\n\nYᴏᴜ ᴄᴀɴ'ᴛ Gᴇᴛ ᴍᴏᴠɪᴇ ʜᴇʀᴇ........\nAꜱᴋ ᴍᴏᴠɪᴇ ᴏɴ ᴏᴜʀ ɢʀᴏᴜᴘ\nCʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ ᴛᴏ 𝚓ᴏɪɴ👇</b>",reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ​ ", url=f"https://t.me/movieadholokam")]]))
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[                               
            ...
            InlineKeyboardButton('Uᴩᴅᴀᴛᴇꜱ', url='https://t.me/movieadholokammain')
         ]] 
        reply_markup = InlineKeyboardMarkup(buttons)             
        await query.message.edit_text(                     
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ɢʀᴏᴜᴩ', url='https://t.me/movieadholokam'),
        ],[
            InlineKeyboardButton('ʜᴏᴍᴇ', callback_data='start'),
        ...
        buttons = [[
            InlineKeyboardButton('Sᴜᴩᴩᴏʀᴛ Gʀᴏᴜᴩ', url='https://t.me/movieadholokam'),
            InlineKeyboardButton('Bᴏᴛ Uᴩᴅᴀᴛᴇꜱ', url='https://t.me/movieadholokammain')
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('Mᴏᴠɪᴇ Uᴩᴅᴀᴛᴇꜱ', url='https://t.me/movieadholokammain'),
            InlineKeyboardButton('Gʀᴏᴜᴩ', url='https://t.me/movieadholokam')
            ],[
            InlineKeyboardButton('Bᴏᴛ Uᴩᴅᴀᴛᴇꜱ', url='https://t.me/movieadholokammain')
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('📞 Cᴏɴᴛᴀᴄᴛ', url='https://t.me/ff_amalshan'),
        ...
        buttons = [[
           InlineKeyboardButton('ɢʀᴏᴜᴩ', url='https://t.me/movieadholokam'),
           InlineKeyboardButton('ᴏᴡɴᴇʀ', url='https://t.me/ff_amalshan')
        ], [
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='help')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
